...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df2, values='class count', names='class',
...
def get_scatter_chart(entered_site, slider_range): 
    ...
    if entered_site == 'ALL':
        ...
        scatter_df2 = spacex_df[(spacex_df['Launch Site'] == entered_site)]
        scatter_df2 = scatter_df2[scatter_df2['Payload Mass (kg)'].between(low, high)]
        fig = px.scatter(scatter_df2, x="Payload Mass (kg)", y="class", color='Booster Version Category') 
        return fig
